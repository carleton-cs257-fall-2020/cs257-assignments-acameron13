...
class BooksDataSourceTester(unittest.TestCase):
  def setUp(self):
    self.bds = booksdatasource.BooksDataSource(books.csv, authors.csv)
  ...
  def test_booksf_author_id_exists(self):
    ...
    self.assertEquals(self.bds.books(author_id=22), return_list)

  def test_booksf_author_id_empty(self):
    return_list = []
    self.assertEquals(self.bds.books(author_id=13), return_list)
  
  def test_booksf_search_text_exists(self):
    return_list = [{'title': 'Great Expectations', 'publication_year': 1860, 'author_id': 22}]
    self.assertEquals(self.bds.books(search_text='Great Exp'), return_list)

  def test_booksf_search_text_empty(self):
    return_list = []
    self.assertEquals(self.bds.books(search_text='Moby Dick'), return_list)
  ...
  def test_booksf_sort_by_title(self):
    ...
    self.assertEquals(self.bds.books(sort_by='title'), return_list)
  ...
  def test_booksf_sort_by_pub_year(self):
    ...
    self.assertEquals(self.bds.books(sort_by='year'), return_list)
  ...
  def test_booksf_author_id_search_text(self):
    return_list = [{'title': 'Great Expectations', 'publication_year': 1860, 'author_id': 22}]
    self.assertEquals(self.bds.books(author_id=22, search_text='grea'))

  def test_booksf_author_id_start_year(self):
    return_list = [{'title': 'Great Expectations', 'publication_year': 1860, 'author_id': 22}]
    self.assertEquals(self.bds.books(author_id=22, start_year=1860))

  def test_booksf_author_id_year_range(self):
    return_list = [{'title': 'Great Expectations', 'publication_year': 1860, 'author_id': 22}]
    self.assertEquals(self.bds.books(author_id=22, start_year=1850, end_year=1870), return_list)
  ...
  def test_booksf_search_text_sort_by_pub_year(self):
    ...
    self.assertEquals(self.bds.books(search_text='ea', sort_by='year'), return_list)
  ...
  def test_booksf_year_range_invalid(self):
    #start_year > end_year
    return_list = []
    self.assertEquals(self.bds.books(start_year=1870, end_year=1860), return_list)
  ...
  def test_authorf_search_text_empty(self):
    return_list = []
    self.assertEquals(self.bds.authors(search_text='George'), return_list)
  ...
  def test_authorf_search_text_none(self):
    ...
    self_assertEquals(self.bds.authors(), return_list)
